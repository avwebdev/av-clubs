    ...
    email: async function (announcements) {
        ...
        for (var announcement of announcements) {
            ...
            html += `</p>${announcement["Paragraph 1"]}<br><br>
                        ${announcement["Paragraph 2"] ? announcement["Paragraph 2"] + "<br><br>" : ""}
                        ${announcement["Paragraph 3"] ? announcement["Paragraph 3"] + "<br><br>" : ""}
                        ${announcement["Paragraph 4"] ? announcement["Paragraph 4"] + "<br><br>" : ""}
                        ${announcement["Paragraph 5"] ? announcement["Paragraph 5"] + "<br><br>" : ""}</p>
